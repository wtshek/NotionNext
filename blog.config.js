...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '3ab6825fc23e44bc90d098dae46188ab', // changed to my template, so can be seen on dev mode
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Shek', // 您的昵称 例如 tangly1024
  BIO:
    process.env.NEXT_PUBLIC_BIO ||
    'A Living Creature, who writes about everything. I surprise myself sometimes.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wtshek119@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER:
    process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/WTShek', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://twitter.com/WTShek', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN:
    process.env.NEXT_PUBLIC_CONTACT_LINKEDIN ||
    'https://www.linkedin.com/in/wing-tung-shek/', // 你的linkedIn 首页
